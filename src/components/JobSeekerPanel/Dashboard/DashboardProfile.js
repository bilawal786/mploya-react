...
const DashboardProfile = () => {
    ...
    return (
        <>
            ...
            <strong className="m-3 text-white">About</strong>
            ...
            <div className="d-flex flex-row justify-content-center align-items-center">
                ...
                <strong className="mx-2 text-white">Watch <span className="text-success">Airbnb</span> <br /> Introduction Video</strong>
            </div>


            <strong className="m-3 text-white">What we do</strong>
            <div className="aboutme-round-sm p-3 mb-3">
                <div className="d-flex flex-row align-items-center">
                    <img class="icon-img" src="https://i.imgur.com/IRsUTtE.jpg" alt="image" />

                    <div className="px-3 d-flex flex-column">
                        <small className="text-white"><strong>Graphic Designer</strong></small>
