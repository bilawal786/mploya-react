            ...
            <div className='container my-container'>
                ...
                <div className='row'>
                    ...
                    <div className="col-sm-4 col-md-4 col-lg-4 my-3">
                        <div className="card text-center shadow-lg pop-companies-card ">
                            <div className="card-body">
                            <i class="fa fa-google-plus fa-3x" aria-hidden="true"></i>                                <h4 className="card-title">Google</h4>
                                <p className="card-text"><i class="fa fa-map-marker" aria-hidden="true"></i> San Francisco</p>
                                <a className="section-link" href="default.asp"><b>10+ Jobs Open</b></a>
                            </div>
                        </div>
                    </div>
                    <div className="col-sm-4 col-md-4 col-lg-4 my-3">
                        <div className="card text-center shadow-lg pop-companies-card ">
                            ...
                            <i class="fa fa-google-plus fa-3x" aria-hidden="true"></i>                                <h4 className="card-title">Google</h4>
                                <p className="card-text"><i class="fa fa-map-marker" aria-hidden="true"></i> San Francisco</p>
                                <a className="section-link" href="default.asp"><b>14+ Jobs Open</b></a>
                            </div>
                        </div>
                    </div>
                    <div className="col-sm-4 col-md-4 col-lg-4 my-3">
