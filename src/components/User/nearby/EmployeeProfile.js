...
const EmployeeProfile = (props) => {
      const employeeId = props.location.state.id;
      ...
      useEffect(async () => {
            ...
            try {
                  const res = await Axios({
                        method: 'GET',
                        url: 'https://mploya.com/api/single/jobseeker/' + employeeId,
                        headers: {
            ...
            return (
                  <div className="aboutme-round-sm p-3 my-3">
                        ...
                        <div className='mt-3 d-flex flex-row flex-wrap align-items-center'>
                              {employee.skill_name
                                    ? JSON.parse(employee.skill_name).map((skill) => {
                                          return (
                                                <p className='rounded shadow-lg px-2 bg-green text-white' style={{marginRight:'5px'}}>{skill}</p>
                                          );
                                    })
                                    : <p>No Skills</p>
                              }
      ...
      const RenderLanguages = () => {
            return (
                  <div className="aboutme-round-sm p-3 my-3">
                        ...
                        <div className='mt-3 d-flex flex-row flex-wrap align-items-center'>
                              {employee.language
                                    ? JSON.parse(employee.language).map((item) => {
                                          return (
                                                <p className='rounded shadow-lg px-2 bg-green text-white' style={{marginRight:'5px'}}>{item}</p>
                                          );
                                    })
                                    : <p>No Language</p>
                              }
                  ...
                  <div className="container-fluid ">
                              ...
                              <div className="card bg-transparent border-0">
                                    <div className="top-response d-flex justify-content-between align-items-center">
                                          <div className="d-flex flex-row">
                                                <img className="calendar-top-img text-center" src={employee.image ? "https://mploya.com/" + employee.image : "https://i.imgur.com/IRsUTtE.jpg"} />
                                                <div className="px-3 d-flex flex-column">
                                                      <h4 className="mb-0 text-white">{employee.name ? employee.name : 'No name'}</h4>
                                                      <p className="text-white mb-0">
                                                            <small><i class="fa fa-map-marker fa-sm" aria-hidden="true"></i>&nbsp;{employee.address ? employee.address : 'No address'}</small>
                                                      </p>
                                                      <p className="text-white my-0">
                                                            <small><i class="fa fa-at fa-sm" aria-hidden="true"></i>&nbsp;{employee.email ? employee.email : 'No Email'}</small>
                                                      </p>
                                                </div>

                                          </div>
                                          <div>
                                                <button className="btn btn-success btn-sm rounded-pill px-3">Button</button>
                                          </div>
                        ...
                        <div className="row">
                              <div className="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <div className="aboutme-round-sm p-3 my-3">
                                          <strong>Jobseeker Detail</strong>

                                          <p align="justify" className="my-3 text-muted">{employee.description}</p>
                                    </div>
                                    <RenderSkills />
                                    <RenderLanguages />
                              ...
                              <div className="col-sm-6 col-md-6 col-lg-6">
                                          ...
                                          <div className="col">
                                                ...
                                                <div className="my-3">
                                                      ...
                                                      <button className="rounded-pill border-0 px-3 py-2 mb-2 bg-redish w-100">
                                                            ...
                                                            <span className="mx-3">{employee.instagram_link}</span>
                                                      </button>
                                                      <button className="rounded-pill border-0 px-3 py-2 mb-2 bg-blueish w-100">
                                                            ...
                                                            <span className="mx-3">{employee.twitter_link}</span>
                                                      </button>
                                                </div>
                                          </div>
                                    </div>
                                    <div className="aboutme-round-sm my-3 p-0">
                                          ...
                                          <ReactPlayer url={employee.video ? "https://mploya.com/" + employee.video : "https://www.youtube.com/watch?v=7sDY4m8KNLc&ab_channel=Codevolution"} controls width='100%' />
                                          <br />
                                    </div>
