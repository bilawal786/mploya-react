                ...
                <form onSubmit={onSubmit}>
                        ...
                        <div className="card bg-transparent border-0">
                            <div className="top-response d-flex justify-content-between align-items-center">
                                <div className="top-response d-flex flex-column">
                                    ...
                                    <input id="profilePic" name="image" type="file" onChange={onChangePicture} className='d-none' />
                                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div className="aboutme-round-sm p-3 my-3">
                                <strong>Name</strong>
                                <input type="text" name="name" value={data.name} className="form-control border-0 my-2" onChange={inputEvent} defaultValue='Airbnb' />

                            </div>
                            <div className="aboutme-round-sm p-3 my-3">
                                <strong>Company name</strong>
                                <input type="text" name="company_name" value={data.company_name} className="form-control border-0 my-2 " onChange={inputEvent} defaultValue='Homing' />
                            ...
                            <div className="aboutme-round-sm p-3 my-3">
                                ...
                                </div>
                                {
                                    languages.map((language, index) => {
                                        return (
                                            <div key={index}>
                                                <input className='rounded-pill border-0 shadow mt-1 px-3 py-1' value={language} onChange={(e) => changeLanguageHandler(e, index)}
                                                    required
                                                />
                                                <span className='mx-2' type='button' onClick={() => removeLanguageHandler(index, language)}>
                            ...
                            <div className="aboutme-round-sm p-3 my-3">
                                ...
                                <input type="text" name="address" value={data.address} className="form-control border-0 my-2 " onChange={inputEvent} defaultValue='Los Angels, CA' />
                            </div>
                            <div className="aboutme-round-sm p-3 my-3">
                            ...
                            <div className='aboutme-round-sm p-3 my-3'>
                                ...
                                <div className="my-3">
                                    <div className="social-link-input mb-2">
                                        <input type="text" value={data.facebook_link} name="facebook_link" onChange={inputEvent} className="form-control border-0 rounded-pill bg-blueish px-4" defaultValue="/Airbnb" />
                                        <div className="social-link-icon"><i className="fa fa-facebook-f text-primary"></i></div>

                                    </div>
                                    <div className="social-link-input mb-2">
                                        <input type="text" value={data.linkedin_link} name="linkedin_link" onChange={inputEvent} className="form-control border-0 rounded-pill bg-berry px-4" defaultValue="/Airbnb" />
                                        <div className="social-link-icon"><i className="fa fa-linkedin text-info"></i></div>

                                    </div>
                                    <div className="social-link-input mb-2">
                                        <input type="text" value={data.instagrame_link} name="instagrame_link" onChange={inputEvent} className="form-control border-0 rounded-pill bg-redish px-4" defaultValue="/Airbnb" />
                                    ...
                                    <div className="social-link-input mb-2">
                                        <input type="text" value={data.twitter_link} name="twitter_link" onChange={inputEvent} className="form-control border-0 rounded-pill bg-blueish px-4" defaultValue="/Airbnb" />
                                        <div className="social-link-icon">
