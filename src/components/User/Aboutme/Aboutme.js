                    ...
                    <div className="col-sm-4 col-md-4 col-lg-3">
                        ...
                        <div className="my-3">
                            <button className="rounded-pill border-0 px-3 py-2 mb-2 bg-blueish w-100">
                                ...
                                <small className="mx-3"><b>{employer.facebook_link}</b></small>
                            </button>
                            <button className="rounded-pill border-0 px-3 py-2 mb-2 bg-berry w-100">
                                <i className="fa fa-linkedin text-info"></i>
                                <small className="mx-3"><b>{employer.linkedin_link}</b></small>
                            </button>
                            <button className="rounded-pill border-0 px-3 py-2 mb-2 bg-redish w-100">
                                ...
                                <small className="mx-3"><b>{employer.instagram_link}</b></small>
                            </button>
                            <button className="rounded-pill border-0 px-3 py-2 mb-2 bg-blueish w-100">
                                ...
                                <small className="mx-3"><b>{employer.twitter_link}</b></small>
                            </button>
                        </div>
                    </div>
