    ...
    return (
        <>
            ...
            <div className="d-flex">
                <div className="w-50 text-white">
                    <div className="d-flex flex-row align-items-center my-2">
                        <h4 className="my-0"><strong>342</strong></h4>
                ...
                <div className="w-50 text-white">
                    <div className="d-flex flex-row align-items-center my-2">
                        <h4 className="my-0"><strong>984</strong></h4>
            ...
            <div className="d-flex">
                <div className="w-50 text-white">
                    <div className="d-flex flex-row align-items-center my-2">
                        <h4 className="my-0"><strong>15k</strong></h4>
                ...
                <div className="w-50 text-white">
                    <div className="d-flex flex-row align-items-center my-2">
                        <h4 className="my-0"><strong>435</strong></h4>
