                  ...
                  <div className='row'>
                        <nav className="navbar navbar-expand-lg navbar-light bg-transparent">
                              ...
                              <div className="container-fluid">
                                    <img src="/mployalogo.png" alt="Logo" width="80" height="50" />
                                    ...
                                    <div className="collapse navbar-collapse" id="navbarText">
                                          ...
                                          <NavLink exact to="/signin" type="button" className='btn sbtn' style={{ backgroundColor: '#067d1f', color: 'white' }} >Sign In</NavLink>
                                          <NavLink exact to="/register" type="button" className='btn fbtn' style={{ marginLeft: '10px', backgroundColor: '#067d1f', color: 'white' }}>Sign Up</NavLink>
                                    </div>
                              </div>
                        </nav>
                        {/* Header Componenet */}
