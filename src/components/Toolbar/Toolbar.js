...
const Toolbar = props => (
      ...
      <header className="toolbar">
            <nav className="toolbar__navigation">
                  ...
                  <div className="spacer" />
                  <NavLink exact to="/signin" type="button" className='btn btn-success sbtn mt-4' style={{ backgroundColor: '#067d1f', color: 'white', marginRight: "0px" }} >Sign In</NavLink>
                  <NavLink exact to="/register" type="button" className='btn btn-success fbtn mt-4' style={{ marginLeft: '10px', backgroundColor: '#067d1f', color: 'white', marginRight: "40px" }}>Sign Up</NavLink>
                  <div className="spacer" />
